...
add_packages "jwm" "nodm xserver-xorg jwm menu wicd rox-filer iceweasel"
...
cp "${BASE_DIR}/modules/jwm/nodm-hooks.chroot" "${BUILD_DIR}/config/hooks/"
cp "${BASE_DIR}/modules/jwm/minimal.chroot" "${BUILD_DIR}/config/hooks/"
cp "${BASE_DIR}/modules/jwm/stripped.chroot" "${BUILD_DIR}/config/hooks/"
